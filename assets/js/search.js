...
function initSearch() {
    ...
    require(['/assets/js/vendor/lunr.min.js', 'https://cdn.jsdelivr.net/gh/MihaiValentin/lunr-languages@latest/lunr.stemmer.support.js', 'https://cdn.jsdelivr.net/gh/MihaiValentin/lunr-languages@bc6b23fcb6b63fea5b875fbe93f670892878d378/lunr.zh.js'], function(lunr, stemmerSupport, de) {
	stemmerSupport(lunr); 
	zh(lunr); 
